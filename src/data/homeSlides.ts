...
export const homeSlides: HomeSlide[] = [
  {
    ...
    secondaryCta: { label: 'О продукте', href: '/products/keymod/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'О продукте', href: '/products/kvm-go/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'О продукте', href: '/products/minikvm/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Аксессуары', href: '/products/accessories/' },
